...
return new class extends Migration
{
    ...
    {
        Schema::create('fail2ban_blacklist', function (Blueprint $table) {
            $table->id();
            $table->string('ip_or_cidr', 45)->unique()->comment('IP address or CIDR range (e.g., 192.168.1.100 or 192.168.1.0/24)');
            $table->string('reason', 255)->nullable()->comment('Reason for permanent ban');
    ...
    {
        Schema::dropIfExists('fail2ban_blacklist');
    }
};
